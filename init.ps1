...
try {
    ...
    & $mkcert -install
    & $mkcert "*.dempnextjsapp.localhost"
...
Add-HostsEntry "cm.dempnextjsapp.localhost"
if ($Topology -ne "xp0") {
  Add-HostsEntry "cd.dempnextjsapp.localhost"
}
Add-HostsEntry "id.dempnextjsapp.localhost"
Add-HostsEntry "www.dempnextjsapp.localhost"
...
if ($InitEnv) {
    ...
    # CM_HOST
    Set-EnvFileVariable "CM_HOST" -Value "cm.dempnextjsapp.localhost"

    if ($Topology -ne "xp0") {
      # CD_HOST
      Set-EnvFileVariable "CD_HOST" -Value "cd.dempnextjsapp.localhost"
    }

    # ID_HOST
    Set-EnvFileVariable "ID_HOST" -Value "id.dempnextjsapp.localhost"

    # RENDERING_HOST
    Set-EnvFileVariable "RENDERING_HOST" -Value "www.dempnextjsapp.localhost"
