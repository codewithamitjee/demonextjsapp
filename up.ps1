...
if ($ByPass) {
  dotnet sitecore login --cm https://cm.dempnextjsapp.localhost/ --auth https://id.dempnextjsapp.localhost/ --allow-write true --client-id "SitecoreCLIServer" --client-secret "testsecret" --client-credentials true
}else {
  dotnet sitecore login --cm https://cm.dempnextjsapp.localhost/ --auth https://id.dempnextjsapp.localhost/ --allow-write true
}
...
Start-Process https://cm.dempnextjsapp.localhost/sitecore/
Start-Process https://www.dempnextjsapp.localhost/
